...
class _ItemWidgetState extends State<ItemWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildFeaturedItemText(context, const TextStyle(fontSize: 18)),
        _buildFeaturedItemPrice(
            context, const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
      ],
    );
  }
  ...
  Widget _buildFeaturedItemText(BuildContext context, TextStyle style) {
    var screenWidth = MediaQuery.of(context).size.width;
    return SizedBox(
      width: screenWidth * .40,
      child: Text(
  ...
  Widget _buildFeaturedItemPrice(BuildContext context, TextStyle style) {
    var screenWidth = MediaQuery.of(context).size.width;
    return SizedBox(
      width: screenWidth * .40,
      child: Text('\$102.33', style: style),
    );
  }
}
